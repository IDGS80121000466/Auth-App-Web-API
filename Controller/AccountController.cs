...
namespace AuthAPI.Controller
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordDto forgotPasswordDto)
        {
           ...
           // var client = new RestClient("https://send.api.mailtrap.io/api/send");
            //var request = new RestRequest();
            //request.AddHeader("Authorization", "Bearer acd72e1a2936df45ea0d120b7d338c86");
            //request.AddHeader("Content-Type", "application/json");
            //request.AddParameter("application/json", "{\"from\":{\"email\":\"mailtrap@demomailtrap.com\",\"name\":\"Mailtrap Test\"},\"to\":[{\"email\":\"emmanuelescobedogonzalez042@gmail.com\"}],\"template_uuid\":\"16d88a00-af69-4890-a0f4-2a6144bddf30\",\"template_variables\":{\"user_email\":\"Test_User_email\",\"pass_reset_link\":\"Test_Pass_reset_link\"}}", ParameterType.RequestBody);
           ...
           // System.Console.WriteLine(response.Content);
            ...
            request.AddJsonBody(new
            {
                ...
                template_uuid = "16d88a00-af69-4890-a0f4-2a6144bddf30",
